...
func makeFileURL(named name: String, file: StaticString, inSiblingDirectory directory: String) -> URL {
...
func decodeContentsOfFile<T: Decodable>(named name: String, file: StaticString, inSiblingDirectory directory: String) throws -> T {
    let data = try Data(contentsOf: makeFileURL(named: name, file: file, inSiblingDirectory: directory))
    return try JSONDecoder().decode(T.self, from: data)
}

func contentsOfFile(named name: String, file: StaticString, inSiblingDirectory directory: String) throws -> String {
    try String(contentsOf: makeFileURL(named: name, file: file, inSiblingDirectory: directory))
}
